...
-- Shrink DB
DBCC SHRINKDATABASE('StackOverflow2010');
GO 
...
-- DBJobsGlobalAzure2024
IF (DB_ID('DBJobsGlobalAzure2024') IS NOT NULL)
BEGIN
  ALTER DATABASE [DBJobsGlobalAzure2024]
    SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
	DROP DATABASE [DBJobsGlobalAzure2024];
END
GO

CREATE DATABASE [DBJobsGlobalAzure2024];
GO
